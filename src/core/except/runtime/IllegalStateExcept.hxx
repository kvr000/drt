 ...
 */
class DR_PUB IllegalStateExcept: public RuntimeExcept
{
	DR_THROW_DECL_SIMPLE(IllegalStateExcept, RuntimeExcept);

public:
	/** construct IllegalStateExcept:
	 *
	 * @param whom
	 ...
	 */
	DR_CONSTRUCT			IllegalStateExcept(Object *whom, const String &message);
