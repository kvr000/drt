 ...
 */
class DR_IO_PUB IoExcept: public Except
{
	DR_THROW_DECL_SIMPLE(IoExcept, Except);
...
public:
	 ...
	 * 	posix error code
	 */
	DR_CONSTRUCT			IoExcept(Handle *handle, const String &operation, int posix_error, int minor_error);
	 ...
	 * 	posix error code
	 */
	DR_CONSTRUCT			IoExcept(Throwable *previous, Handle *handle, const String &operation, int posix_error, int minor_error);
