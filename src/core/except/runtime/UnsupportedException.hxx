 ...
 */
class DR_PUB UnsupportedException: public RuntimeException
{
	DR_THROW_DECL_SIMPLE(UnsupportedException, RuntimeException);

public:
	/** construct UnsupportedException:
	 *
	 * @param whom
	 ...
	 * 	unsupported value
	 */
	DR_CONSTRUCT			UnsupportedException(const Object *whom, const String &originator, const String &option = Null(), const String &value = Null());
