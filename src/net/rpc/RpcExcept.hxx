 ...
 */
class DR_NET_PUB RpcExcept: public Except
{
	DR_THROW_DECL_SIMPLE(RpcExcept, Except);
...
public:
	 ...
	 */
	DR_CONSTRUCT			RpcExcept(const String &description);
	 ...
	 */
	DR_CONSTRUCT			RpcExcept(Throwable *previous, const String &description);
